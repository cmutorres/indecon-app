...
public class LastFixture {
    ...
    public static UltimosValores getRsMetales() {
        UltimosValores ultimosValores = new UltimosValores();
        try {
            ObjectMapper mapper = new ObjectMapper()
                    .configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
            ultimosValores = mapper.readValue(bodyRsLast, UltimosValores.class);
        } catch (IOException e) {
            new Throwable(e);
        }
